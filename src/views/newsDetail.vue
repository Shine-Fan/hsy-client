  ...
  <div class="main" style="width:100%;height:100%;display: flex;flex-direction: column;align-items: center;position:absolute;top:0;">
    <div style="position:relative;height:100%;top:0;width:90%;margin-bottom:2.6rem">
      <div class="main-area" style="position:absolute;height:100%;width:100%;overflow:scroll;top:0">
        <div class="title">
          <h4>灾害损失减少30%、整精米率提高8%——水稻新品种“中科发5号”选育成功</h4>
        </div>
        <div class="from" style="width:95%;height:3.5rem;display: flex;align-items: center;margin:auto">
          <router-link to="/community_detail" style="width:100%">
            <div style="width:100%;display: flex;">
              <div style="width:3rem;height:3.5rem;display: flex;align-items: center;justify-content: center">
                <img src="../assets/corn.jpg" style="width:2.5rem;height:2.5rem;border-radius:50%;">
              </div>
              <div style="width:100%;height:3.5rem;display:flex;flex-direction: column;justify-content: center;margin:0 10px">
                <div style="font-weight: bold;color:black">水稻专家</div>
                <div style="font-size:0.8rem;color:gray;">十小时前</div>
              </div>
            </div>
          </router-link>
        ...
        <div class="content">
          <p>9月11日，国审稻新品种“中科发5号”及中科发系列新品种现场会在吉林省吉林市举行。在2000亩示范片中，“中科发5号”等新品种在产量、抗稻瘟病、抗倒伏等农艺性状中表现突出，外观品质优、食味佳，丰收在即。</p>
          <img src="../assets/news8.jpg" style="width:70%;height:auto;">
          <p>中科发系列粳稻新品种，是中国科学院遗传与发育生物学研究所李家洋院士与合作者联合，针对东北地区最主要的优质米品种“稻花香”在生产中所遇到的问题，以优异稻米品质基因、抗倒伏和抗稻瘟病等基因为主线，结合高产及理想株型基因等，运用分子模块设计育种的理念和技术，经过精心设计，选育而成的具有优质、高产、抗稻瘟病和抗倒的中科发系列粳稻新品种。“中科804”于2017年通过国家审定（国审稻20170080），“中科发5号”（国审稻20180077）和中科发6号(国审稻20180071）于2018年通过国家审定。其中,“中科804”在黑龙江五常市稻花香主产区3000亩示范片中脱颖而出，示范推广工作当选中国科学院2018年第3季度和全年的科技创新亮点成果及科技成果转移转化亮点成果，并入选2018年中国十大科技进展新闻。2019年“中科804”推广应用面积已达20万亩以上。</p>
          <p>目前，“中科发5号”等品种的大面积示范推广工作正在进行。2019年“中科发5号”共示范20000多亩，在黑龙江、吉林、辽宁、宁夏、内蒙共布置了40多个百亩以上示范片，其中在吉林省吉林市布置了2000亩连片示范片，目前所有示范片及生产上均长势优良，同稻花香相比，“中科发5号”和“中科804”预计增产100kg/亩以上，抗稻瘟病和抗倒伏等抗逆性强可减少灾害损失30%，品质优良，口感更佳，尤其是整精米率，比稻花香提高8%以上。随着这些品种的大面积推广种植，其优良性状所带来的经济和社会效益将日趋凸显。</p>
        </div>
        ...
        <div class="comment-area">
          ...
          <comment-bar v-for="(item,index) in commentList"
                       :key="index"
                       :img_src="item.img"
                       :user_name="item.user"
...
export default {
  ...
  methods: {
    ...
    send_comment: function () {
      if (this.isWriting) {
        var item = {}
        item.img = require('../assets/user.jpg')
        item.user = 'Shine'
        item.comment = this.comments
        item.thumbs = 0
