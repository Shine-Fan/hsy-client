<template>
  ...
  <div><UserContent style="float:right"></UserContent></div>
...
.my{padding-top: 40px; width:1170px; margin: 0 auto; padding-bottom: 20px; overflow: hidden;}
